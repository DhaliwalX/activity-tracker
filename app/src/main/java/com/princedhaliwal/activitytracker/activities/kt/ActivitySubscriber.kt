...
import com.princedhaliwal.activitytracker.MainActivity.TAG
import com.princedhaliwal.activitytracker.utils.doAsyncTask
...
class ActivitySubscriber(val googleApiClient: GoogleApiClient) {
